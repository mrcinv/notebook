...
BLOG_AUTHOR = "Martin Vuk"
BLOG_TITLE = "My public notebook"
...
BLOG_EMAIL = "martin.vuk@fri.uni-lj.si"
BLOG_DESCRIPTION = "My logbook, which is also public."
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://github.com/mrcinv', 'My Github', 'icon-github'),
    ),
    'sl': (
        ('/sl/index.html', 'Domov', 'icon-home'),
        ('/sl/archive.html', 'Arhiv', 'icon-folder-open-alt'),
        ('/sl/categories/index.html', 'Značke', 'icon-tags'),
        ('/sl/rss.xml', 'RSS', 'icon-rss'),
        ('/sl/stories/about-me.html', 'O meni', 'icon-user'),
        ('https://github.com/mrcinv', 'Github', 'icon-github'),
    ),
}
...
LICENSE = """
<a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/2.5/sl/">
<img alt="Creative Commons License BY-NC-SA"
style="border-width:0; margin-bottom:12px;"
src="http://i.creativecommons.org/l/by-nc-sa/2.5/sl/88x31.png"></a>"""
...
# is in the manual.
COMMENT_SYSTEM_ID = "mrcinlogbook"
